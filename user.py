...
wb = load_workbook("C:\\Users\\user\\Desktop\\코딩\\python project\\디코(게임)봇\\데이터파일\\userDB.xlsx")
ws = wb.active
...
def saveFile():
    wb.save("C:\\Users\\user\\Desktop\\코딩\\python project\\디코(게임)봇\\데이터파일\\userDB.xlsx")
    wb.close()
